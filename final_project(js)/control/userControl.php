<?php
    ...
    function show_complaint_history_table(){
        global $user;
        foreach(get_complaint_history_table($user) as $r){
            echo "<tr>";
            echo "<td>$r[comno]</td>";
            echo "<td>$r[date]</td>";
            echo "<td>$r[status]</td>";
            if($r['status'] == 'Sent'){                         
                echo "<td><button class='tableButton' type='submit' name='edit' value='$r[comno]'>Edit</button></td>";
                echo "<td><button class='tableButton' type='submit' name='delete' value='$r[comno]'>Delete</button></td>";
            }
